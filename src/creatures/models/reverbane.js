...
export function build_reverbane(kit = kitDefault) {
  ...
  const eyeL = kit.at(head, S.eye(kit, 0.021, { irisColor: 0xd8cfff, scleraColor: 0x18121e, skinColor: furHex, glintSize: 0.009, irisScale: 1.2 }), 0.038, 0.008, 0.056, { ry: 0.35 });
  const eyeR = kit.at(head, S.eye(kit, 0.021, { irisColor: 0xd8cfff, scleraColor: 0x18121e, skinColor: furHex, glintSize: 0.009, irisScale: 1.2 }), -0.038, 0.008, 0.056, { ry: -0.35 });
